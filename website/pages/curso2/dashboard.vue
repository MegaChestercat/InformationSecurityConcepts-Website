    ...
    <div>
      <v-img height="270" width="100vw" src="~~/assets/auth_bg.png" cover>
        <div class="d-flex justify-center align-center fill-height">
          <div class="d-block">
            <p class="text-white text-center text-h3 font-weight-bold">Hacking y Sistemas de Detección de Intrusiones
            </p>
        ...
        <v-sheet>
          ...
          <v-sheet :elevation="5" width="75vw" height="350" class="mx-15 mt-8 rounded-xl">
            <div class="d-flex align-center fill-height">
                ...
                <iframe width="560" height="315" src="https://www.youtube.com/embed/3f8YAEfSlEY?si=CdIixdOUMJgJzROL"
          ...
          <v-sheet :elevation="5" width="75vw" height="350" class="mx-15 mt-8 rounded-xl">
            <div class="d-flex align-center fill-height">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/nuPYFRlBM58?si=XmT9o_z7YX5UIUSR"
                  title="YouTube video player" frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
          ...
          <v-sheet :elevation="5" width="75vw" height="350" class="mx-15 mt-8 rounded-xl">
            <div class="d-flex align-center fill-height">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/qouJ7sxu0Dc?si=dDiXNttiG2Ynnct8"
                  title="YouTube video player" frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
          ...
          <v-sheet :elevation="5" width="75vw" height="350" class="mx-15 mt-8 rounded-xl">
            <div class="d-flex align-center fill-height">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/MwqdKevOas0?si=kxsku5x8oxB9y5Et"
                  title="YouTube video player" frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
          ...
          <v-sheet :elevation="5" width="75vw" height="350" class="mx-15 mt-8 rounded-xl">
            <div class="d-flex align-center fill-height">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/mcTCrTneeco?si=w7IzGx6wmXSi7GsT"
                  title="YouTube video player" frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
          ...
          <v-sheet :elevation="5" width="75vw" height="350" class="mx-15 mt-8 rounded-xl">
            <div class="d-flex align-center fill-height">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/_sVObRVfoms?si=qvrdZMGWKWrC7Ili"
                  title="YouTube video player" frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
